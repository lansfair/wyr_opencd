...
launcher = 'none'
load_from = '/mnt/ht2-nas2/EO_test/openmmlab-archive/v1/open-cd/work_dirs/oscd/epoch_50.pth'
log_level = 'INFO'
...
model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(
            checkpoint=
            '/mnt/ht2-nas2/EO_test/openmmlab-archive/v1/open-cd/pretrained/CopernicusFM_ViT_base_varlang_e100.pth',
            type='Pretrained'),
        input_mode='spectral',
        kernel_size=16,
        norm_eval=True,
...
visualizer = dict(
    ...
    name='visualizer',
    save_dir=
    '/mnt/ht2-nas2/EO_test/wry/open-cd/projects/copernicusfm/infer-results/vis_data/vis_image1',
    type='CDLocalVisualizer',
    vis_backends=[
        dict(type='CDLocalVisBackend'),
    ])
work_dir = '/mnt/ht2-nas2/EO_test/openmmlab-archive/v1/open-cd/work_dirs/oscd'
